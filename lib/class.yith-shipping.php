...
if ( ! class_exists( 'YITH_Shipping' ) ) {
	...
	class YITH_Shipping extends YITH_Document {
		...
		public function show_invoice_template_sender() {
			...
			echo '<span class="invoice-from-to">' . esc_html__( 'Shipping From:', 'yith-woocommerce-pdf-invoice' ) . '</span>';
		...
		public function show_invoice_template_customer_data() {
			...
			if ( $order->get_formatted_shipping_address() ) {
				echo '<span class="invoice-from-to" > ' . esc_html__( 'Shipping To:', 'yith-woocommerce-pdf-invoice' ) . '</span > ' . wp_kses( $order->get_formatted_shipping_address(), array( 'br' => array() ) );
			}
		...
		public function show_invoice_template_invoice_data() {
			...
			<table>
				...
				<tr class="invoice-date">
					<td><?php esc_html_e( 'Order date', 'yith-woocommerce-pdf-invoice' ); ?></td>
